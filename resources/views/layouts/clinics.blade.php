...
@include('pages.clinics.profile-modal')
@include('pages.clinics.subscription-modal')

<a href="#" class="scroll_to_top hvr-grow" id="scroll"><span class="fa fa-angle-up fa-2x"></span></a>

@include('pages.clinics.small-header')

@include('pages.clinics.nav')

@include('pages.clinics.breadcrumbs')
...
<script type="text/javascript" src="{{ asset("js/subscriptionmodal.js") }}"></script>
