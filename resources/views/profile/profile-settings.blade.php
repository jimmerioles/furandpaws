          ...
          <article>
              <section>
                  <div id="buddypress">
                      ...
                      <div id="item-body">
                          <div><a href="{{ url('/profile/profile-settings') }}" class="current-selected">General</a></div>
                          <div ><a href="{{ url('/profile/profile-edit') }}">Profile Visibility</a></div>
                          <div><a href="{{ url('profile/') }}">Type of user</a></div>
                          ...
                          <div class="editfield">
                              ...
                              <input id="currentpassword" name="field_1" type="password" aria-required="true">
                              <div class="field-visibility-settings-notoggle">
                                  Required to change current password<span class="current-visibility-level"> (Required)</span>
                              </div>
                          ...
                          <div class="editfield">
                              ...
                              <div class="field-visibility-settings-notoggle">
                                  Leave blank for <span class="current-visibility-level"> No Changes</span>
                              </div>
                              <p class="description"></p>
                          </div>

                          <div class="editfield">
                              <label>Change Password(leave blank for no changes)</label>
                              <input id="newpass" name="field_1" type="password" placeholder="New password" aria-required="true"/>
                              <br>
                              <br>
                              <input id="repass" name="field_1" type="password" placeholder="Re-type password"  aria-required="true"/>
