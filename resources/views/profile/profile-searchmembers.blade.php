...
@section('title', 'Searching Other Members')
    ...
    <div class="section-content clearfix">
        ...
        <div class="content-left">
            ...
            <article>
                            ...
                            <div id="cover-image-container">
                                ...
                                <div id="item-header-cover-image">
                                    ...
                                    <div id="item-header-content">
                                        ...
                                        <div id="item-buttons">
                                            <div class="generic-button friendship-button awaiting_response_friend" id="#">
                                                <button class="btn-comment pull-left" style="padding: 4px 10px;font-size: small;text-transform: none" id="addfriend">Add Friend</button>
                                            </div>
                                        </div>
                ...
                <br>
                <button class="btn-comment pull-right">Comment</button>
                <br>
                <hr>
                <br>
...
<script>
        $(document).ready(function(){
            ...
            $('#addfriend').click(function(){
                $(this).text('Friends request sent');
                $(this).click(function(){
