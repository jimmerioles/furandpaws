              ...
              <section>
                  <div id="buddypress">
                      ...
                      <div id="item-body">
                        ...
                        <div><a href="{{ url('/profile/profile-delete') }}" class="current-selected">Delete Account</a></div>
                          ...
                          <form action="#" name="account-delete-form" id="account-delete-form" class="standard-form" method="post">


                              <label for="delete-account-understand">
                                  <input type="checkbox" name="delete-account-understand" id="delete-account-understand">
                                  I understand the consequences.	</label>
                          </form>
                          <br>
                          <button class="btn-comment pull-left" id="delete-account-button" disabled="">Delete my account</button>
                      </div>
